...
<div class="container">
	...
	<a href="#mobile" data-modal="mobile" class="burger" ><i class="fa fa-bars" aria-hidden="true"></i></a>
</div>
<div class="container">
	<div class="menu-box">
		<ul class="main-menu">
...
<div class="header-top-fixed">
	<div class="container">
		...
		<a href="#ask-question" data-modal="modal" class="button-question">Заказать ремонт</a>
	</div>
</div>
